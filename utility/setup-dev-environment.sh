...
git clone https://gitlab.com/serial-lab/quartet_vrs.git
...
pip install -e ./quartet_output
pip install -e ./quartet_masterdata
pip install -e ./quartet_integrations
pip install -e ./quartet_templates
pip install -e ./quartet_vrs
pip install -e ./quartet_trail
...
pip install -e ./quartet_tracelink
